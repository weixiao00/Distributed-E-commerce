...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="lishilin"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15045515313"/>
		<input type="hidden" name="orderShipping.receiverState" value="北京"/>
		<input type="hidden" name="orderShipping.receiverCity" value="北京"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="软件园"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="东四旗"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">lishilin</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">15045515313</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">黑龙江省 绥化市 兰西县</div>
						<div class="adr-m" limit="30">东四旗 xxxxxxxxx</div>
